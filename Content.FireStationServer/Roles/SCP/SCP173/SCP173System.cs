...
public sealed class SCP173System : SharedSCP173System
{
    ...
    private void OnShartAction(EntityUid uid, SCP173Component component, ShartActionEvent args)
    {
        ...
        _puddleSystem.TrySplashSpillAt(uid, Transform(uid).Coordinates, solution, out var puddleId, true);

        var meta = MetaData(puddleId);
        meta.EntityName = "Жидкость SCP";
        meta.EntityDescription = "Стоит поскорее убрать ее...";
